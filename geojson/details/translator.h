...
namespace geojson
{
	namespace details
	{
		...
		struct impl
		{
			...
			{
				using sub_type = typename boost::mpl::at<constructed_from_types<T>, Attribute>::type;
			...
			struct translator_t
			{
				...
				{
					using sub_type = typename boost::mpl::at<constructed_from_types<T>, external_type>::type;
